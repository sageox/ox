...
var Catalog = []Bundle{
	{ID: "core", Description: "Everyday SageOx workflows and skill manager", Default: true, SkillIDs: []string{"ox-consult", "ox-decision", "ox-plan", "ox-pr-header", "ox-recap", "ox-session-review", "ox-skill-manager", "ox-viz"}},
