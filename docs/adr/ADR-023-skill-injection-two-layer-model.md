...
flowchart LR
    ...
    subgraph OX["ox — product CONTRACT (rows)"]
        OXR["capability rows<br/>(consult-first, ox-cli-plan,<br/>ox-cli-session-review, ...)"]
