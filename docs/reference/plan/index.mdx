...
Work with plans (enrich, render, review)

### Synopsis

Work with SageOx-enriched plans: design, GTM, rollout, engineering — any
...
* [ox plan enrich](/plan/enrich)	 - Enrich a plan with SageOx team context (JSON by default)
