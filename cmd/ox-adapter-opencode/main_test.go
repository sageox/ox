...
// TestSkillTargets_SingleCanonicalRoot: opencode declares exactly one write root,
// the canonical .agents/skills.
//
// Before this, opencode declared no skill targets at all, so `ox init` selected it
